...
y_all_pred=pd.read_excel(r'D:/Users/李乐意/PycharmProjects/shumo/zsgc_prac/tupu_diabetes_code.xlsx',header=None).values
y_all=pd.read_excel(r'D:/Users/李乐意/PycharmProjects/shumo/zsgc_prac/drugs_antiDiabetes_tester.xlsx',header=None).values
# print(y_all_pred)
