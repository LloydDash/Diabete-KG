...
y_all_pred=pd.read_excel(os.path.join(cur_dir, 'train\\pred_diabetes_test.xlsx'),index_col=0).values
y_all=pd.read_excel(os.path.join(cur_dir, 'train\\drugs_antiDiabetes_tester.xlsx'),header=None).values
# print(y_all_pred)
