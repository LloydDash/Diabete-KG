...
# 数据预处理
df_y=pd.read_excel(os.path.join(cur_dir, 'train\\drug_without_antiDiabetes_code.xlsx'),header=None)
print(df_y.shape)
X = pd.read_excel(os.path.join(cur_dir, 'train\\disease_withoutDiabetes_code1.xlsx'),header=None).values
y_all=df_y.values
...
X_pred = pd.read_excel(os.path.join(cur_dir, 'train\\disease_withoutDiabetes_code.xlsx'),header=None).values
